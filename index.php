...
<center><h1>SHOPPING CART PAGE</h1></center>
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			<div class="product-price"><?php echo "R.S.".$row["price"]; ?></div>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td  style="text-align:right;"><?php echo "R.S ".$item["price"]; ?></td>
				<td  style="text-align:right;"><?php echo "R.S". number_format($item_price,2); ?></td>
